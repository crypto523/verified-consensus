...
text \<open>  Input syntax for lifting boolean predicates to separation predicates \<close>
...
text \<open> Associative/Commutative Monoid Basis of Separation Algebras \<close>
...
text \<open> Separation Algebra as Defined by Calcagno et al.\<close>
...
text \<open> Basic Construct Definitions and Abbreviations \<close>
...
abbreviation (input) "eq a b \<equiv> (a = b)"
